...
const Sidebar = ({ activeItem = 'Dashboard' }) => {
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { id: 'courses', label: 'My Courses', icon: 'courses', path: '/student/courses' },
        ...
        { id: 'schedule', label: 'Schedule', icon: 'schedule', path: '/student/schedule' },
        { id: 'fees', label: 'Fee Management', icon: 'fees', path: '/student/fees' },
  ...
  const getIcon = (iconType) => {
    const icons = {
      ...
      hostel: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 21L12 12L21 21" stroke="currentColor" strokeWidth="2"/>
          <path d="M5 21V10L12 3L19 10V21" stroke="currentColor" strokeWidth="2"/>
