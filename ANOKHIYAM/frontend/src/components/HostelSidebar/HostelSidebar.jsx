...
const HostelSidebar = ({ activeItem = 'Dashboard' }) => {
  ...
  const menuItems = [
    {
      section: 'MAIN',
      items: [
        { id: 'dashboard', label: 'Dashboard', icon: 'dashboard', path: '/hostel-dashboard' },
        { id: 'rooms', label: 'Room Management', icon: 'rooms', path: '/hostel/rooms' },
        { id: 'occupancy', label: 'Occupancy', icon: 'occupancy', path: '/hostel/occupancy' },
    ...
    },
    {
      section: 'SETTINGS',
      items: [
        { id: 'notifications', label: 'Notifications', icon: 'notifications', path: '/hostel/notifications' },
        { id: 'settings', label: 'Settings', icon: 'settings', path: '/hostel/settings' }
      ]
    }
  ];
