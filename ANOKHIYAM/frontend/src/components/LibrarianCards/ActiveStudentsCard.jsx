...
const ActiveStudentsCard = ({ active = 856, total = 1200, newThisMonth = 45 }) => {
  return (
    <div className={`${styles.card} ${styles.activeStudentsCard}`}>
      ...
      <div className={styles.cardContent}>
        <div className={styles.mainValue}>{active}</div>
        <div className={styles.changeValue}>Active library users</div>
        <div className={styles.description}>{newThisMonth} new registrations this month</div>
      </div>
    </div>
  );
};
