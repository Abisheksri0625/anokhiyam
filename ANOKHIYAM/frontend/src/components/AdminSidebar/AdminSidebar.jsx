  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { id: 'entrance-results', label: 'Entrance Results', icon: 'entrance', path: '/admin/entrance-results' },
        { id: 'semester-results', label: 'Semester Results', icon: 'semester', path: '/admin/semester-results' },
        { id: 'publish-results', label: 'Publish Results', icon: 'publish', path: '/admin/publish-results' },
    ...
    const icons = {
      ...
      staff: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M22 21V19C22 18.1645 21.7155 17.3541 21.2094 16.7006C20.7033 16.047 19.9996 15.5867 19.2 15.3829" stroke="currentColor" strokeWidth="2"/>
          <path d="M15 3.13C15.8604 3.35031 16.623 3.85071 17.1676 4.55232C17.7122 5.25392 18.0078 6.11683 18.0078 7.005C18.0078 7.89318 17.7122 8.75608 17.1676 9.45769C17.623 10.1593 15.8604 10.6597 15 10.88" stroke="currentColor" strokeWidth="2"/>
          <circle cx="17" cy="11" r="2" stroke="currentColor" strokeWidth="2"/>
          <path d="M23 17C23 16.4696 22.7893 15.9609 22.4142 15.5858C22.0391 15.2107 21.5304 15 21 15C20.4696 15 19.9609 15.2107 19.5858 15.5858C19.2107 15.9609 19 16.4696 19 17V18H23V17Z" stroke="currentColor" strokeWidth="2"/>
        </svg>
      ),
      notifications: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
