...
const StudentsAtRiskCard = ({ count = 8, description = "Immediate attention needed" }) => {
  return (
    <div className={`${styles.card} ${styles.atRiskCard}`}>
      <div className={styles.cardHeader}>
        <h3 className={styles.cardTitle}>Students At Risk</h3>
