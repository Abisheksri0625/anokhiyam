...
const TotalStudentsCard = ({ total = 156, active = 148, newThisMonth = 8 }) => {
  return (
    <div className={`${styles.card} ${styles.studentsCard}`}>
      ...
      <div className={styles.cardContent}>
        ...
        <div className={styles.changeValue}>Total Enrolled</div>
        <div className={styles.description}>
          {active} active • +{newThisMonth} new this month
        </div>
      </div>
    </div>
  );
