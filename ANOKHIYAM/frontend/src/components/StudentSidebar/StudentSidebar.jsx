...
const StudentSidebar = ({ activeItem = 'Dashboard' }) => {
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { id: 'grades', label: 'My Grades', icon: 'grades', path: '/student/grades' },
        ...
        { id: 'exams', label: 'Exams', icon: 'exams', path: '/student/exams' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'hostel', label: 'Hostel Info', icon: 'hostel', path: '/student/hostel' },
    ...
    },
    {
      section: 'SETTINGS',
      items: [
        { id: 'profile', label: 'My Profile', icon: 'profile', path: '/student/profile' },
  ...
  const getIcon = (iconType) => {
    const icons = {
      ...
      hostel: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M3 21L21 21M5 21V7L12 3L19 7V21M9 9V21M15 9V21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
      fees: (
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className={styles.sidebar}>
      <div className={styles.logo}>
        ...
        <span className={styles.roleText}>Student Portal</span>
      </div>
