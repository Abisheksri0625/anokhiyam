...
const LibrarianHeader = ({ isCollapsed }) => {
        ...
        <div className={styles.userContainer}>
          ...
          >
            <div className={styles.userInfo}>
              <span className={styles.userName}>Library Manager</span>
              <span className={styles.userRole}>Librarian</span>
            </div>
          ...
          {showUserDropdown && (
            <div className={styles.userDropdown}>
              <a href="/librarian/profile">Profile</a>
              <a href="/librarian/settings">Settings</a>
              <hr />
